...
public static class SettingsManager
{
  ...
  public static void SetMasterVolume(float value)
  {
    ...
    PlayerPrefs.Save();
    // 課題【設定画面】: サウンドシステム未実装のため保存のみ。将来AudioMixer等を
    // 導入した際、ここで実際の音量へ反映する処理を追加する想定。
  }

  public static float GetBgmVolume() => PlayerPrefs.GetFloat(BgmVolumeKey, 1f);
  public static void SetBgmVolume(float value) { PlayerPrefs.SetFloat(BgmVolumeKey, value); PlayerPrefs.Save(); }

  public static float GetSeVolume() => PlayerPrefs.GetFloat(SeVolumeKey, 1f);
  public static void SetSeVolume(float value) { PlayerPrefs.SetFloat(SeVolumeKey, value); PlayerPrefs.Save(); }
